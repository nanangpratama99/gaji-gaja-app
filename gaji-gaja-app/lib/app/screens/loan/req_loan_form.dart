...
class ReqLoanView extends StatefulWidget {
  const ReqLoanView({super.key});

  @override
  State<ReqLoanView> createState() => _ReqLoanViewState();
}

class _ReqLoanViewState extends State<ReqLoanView> {
  @override
